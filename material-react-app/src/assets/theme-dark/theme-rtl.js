// Bu JavaScript kodu, MUI (Material-UI) temasını oluşturan bir tema oluşturucu fonksiyonunu içerir. Tema oluşturulurken renkler, tipografi, bileşen stilleri ve yardımcı işlevler gibi çeşitli özellikler özelleştirilir.

// Bu kodun önemli bileşenleri şunlardır:

// createTheme: MUI temasını oluşturan fonksiyon.
// direction: Temanın yönlendirme ayarı. Bu örnekte sağdan sola (RTL) yönlendirme belirlenmiştir.
// breakpoints: Farklı ekran boyutları için kesme noktalarını içeren bir nesne.
// palette: Renk paletini belirleyen bir nesne.
// typography: Tipografi stillerini belirleyen bir nesne.
// boxShadows: Kutu gölge stillerini belirleyen bir nesne.
// borders: Kenarlık stillerini belirleyen bir nesne.
// functions: Yardımcı işlevleri içeren bir nesne. Bu işlevler gölge oluşturma, renk dönüşümü vb. işlemleri gerçekleştirir.
// components: Her MUI bileşeni için özel stilleri belirleyen bir nesne. Örneğin, çekmece, liste öğeleri, kartlar, düğmeler, giriş alanları vb.
// Bu kod, MUI ile oluşturulan bir temanın bileşenlerini özelleştirmek ve uygulamanın ihtiyaçlarına göre ayarlamak için kullanılabilir.
