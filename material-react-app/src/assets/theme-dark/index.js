// Bu JavaScript kodu, MUI (Material-UI) tema oluşturucu olan createTheme fonksiyonunu kullanarak bir tema oluşturur. Tema oluşturulurken renkler, tipografi, gölgeler, kenarlık ve diğer bileşen stilleri gibi birçok özelliğe özelleştirme yapılır.

// Aşağıdaki kısımlar temayı oluşturan özelleştirme seçeneklerini içerir:

// breakpoints: Farklı ekran boyutları için kesme noktaları belirler.
// palette: Renk paletini tanımlar.
// typography: Tipografi stillerini belirler.
// boxShadows: Kutu gölgelerini ayarlar.
// borders: Kenarlık stillerini belirler.
// functions: Yardımcı işlevleri içerir, örneğin gölge oluşturma veya renk dönüşümü gibi.
// components: Her MUI bileşeni için özel stilleri belirler.
// Bu kod MUI ile oluşturulan bir temanın tüm bileşenlerini kapsar ve her bir bileşen için özel stiller belirler. Bu şekilde, bir uygulamada kullanılacak olan tüm bileşenler için tutarlı bir görünüm elde edilir.
