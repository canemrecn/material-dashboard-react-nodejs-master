// Bu kod, MUI (Material-UI) için bir tema oluşturur. createTheme fonksiyonu, MUI'nin temasını oluşturmak için kullanılır. Bu tema, renkler, tipografi ayarları, gölgeler, kenarlıklar ve bileşenlere özgü stilleri içerir.

// breakpoints, palette, typography, boxShadows, borders: Renkler, tipografi ayarları, gölgeler ve kenarlıklar gibi temel özelliklerin tanımlandığı objeler.
// functions: Temada kullanılan yardımcı işlevlerin tanımlandığı obje. Bu işlevler, gölgeleri oluşturma, renk dönüşümleri gibi işlevleri içerir.
// components: Temada yer alan MUI bileşenlerine özgü stillerin tanımlandığı obje. Her bir MUI bileşeni, kendi stilleriyle birlikte burada tanımlanır.
// Her bileşenin stilleri, temanın bileşenlere özel bölümünde (components altında) belirtilir. Örneğin, MuiButton bileşenine özgü stiller button objesi içinde tanımlanır.

// Bu kod, bir dizi modülü içeri aktararak MUI bileşenlerini özelleştirir ve bir tema oluşturur. Oluşturulan tema, uygulamanın farklı bileşenlerinde kullanılabilir ve MUI bileşenlerinin görünümünü ve davranışını geniş ölçüde değiştirebilir.
