// Bu kod, MUI (Material-UI) için bir RTL (sağdan sola) temayı oluşturur. Öncelikle, createTheme fonksiyonu MUI'nin temasını oluşturmak için kullanılır.

// Bu tema şunları içerir:

// direction: "rtl": Temanın metin yönünü sağdan sola (right-to-left) olarak ayarlar.
...
// Bu kod, assets/theme altındaki modülleri içeri aktararak MUI bileşenlerini özelleştirir ve bir tema oluşturur. Oluşturulan tema, uygulamanın farklı bileşenlerinde kullanılabilir ve MUI bileşenlerinin görünümünü ve davranışını geniş ölçüde değiştirebilir.
