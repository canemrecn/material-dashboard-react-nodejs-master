// Bu kod, kullanıcıların kayıt olabileceği bir formu içeren bir React bileşenidir. Kullanıcıdan ad, e-posta, şifre ve "Koşulları Kabul Ediyorum" seçeneğini seçerek kayıt olmalarını sağlar.
...
// submitHandler işlevi: Kayıt formu gönderildiğinde çağrılır ve kullanıcının giriş bilgilerini kontrol eder. Eğer bilgiler doğruysa, bir kayıt işlemi gerçekleştirilir.
...
// Checkbox: Kullanıcıların "Koşulları Kabul Ediyorum" seçeneğini seçmelerini sağlayan bir onay kutusu bileşenidir.
// InputLabel: "Koşulları Kabul Ediyorum" metnini ve bağlantıyı içeren bir etiket bileşenidir.
// CoverLayout: Arka plan resmiyle birlikte temel bir sayfa düzeni sağlar.
// bgImage: Arka plan resminin URL'sini içerir.
// Bu kod, kullanıcıların kayıt olmalarını ve sisteme giriş yapmalarını sağlayan basit ve kullanıcı dostu bir kayıt formu sunar.
